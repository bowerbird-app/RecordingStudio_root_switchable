...
The gemspec packages `app`, `config`, `db`, and `lib`, plus the license,
Rakefile, README, SECURITY, and CHANGELOG. Cursor boot files and generated pack
files do not ship in the gem.
